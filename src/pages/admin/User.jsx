...
const User = () => {
  ...
  const fetchUsers = async (page = 0, keyword = "", by = searchBy) => {
    try {
      setLoading(true);
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      fetchUsers(0, searchInput, searchBy);
    }, 200);
    ...
    <>
      ...
      {!loading &&
        ...
        (searchInput ? (
          ...
          <div className="us-empty">
            <i className="bi bi-people us-empty-icon" />
            <div className="us-empty__title">Chưa có người dùng nào</div>
            <div className="us-empty__sub">Danh sách người dùng trống</div>
          </div>
        ))}
              ...
              <table className="us-table">
                <thead>
                  <tr>
                    ...
                    <th className="us-th">Tên người dùng</th>
                ...
                <tbody>
                  {users.map((u, index) => (
                    <tr key={u.id} className="us-tr">
                      ...
                      <td className="us-td us-td--email">{u.email}</td>
                      <td className="us-td us-td--name">{u.username}</td>
                      ...
                      <td className="us-td us-td--center">
                        <div className="us-actions">
                          <button
                            className={`us-action-btn ${u.locked ? "us-action-btn--unlock" : "us-action-btn--lock"}`}
                            onClick={() =>
                              setConfirm({ type: "lock", user: u })
                            }
          ...
          {totalPages > 1 && (
            <div className="us-pagination">
              <button
                ...
                onClick={() => fetchUsers(currentPage - 1, searchInput)}
              >
              ...
              {[...Array(totalPages)].map((_, i) => (
                <button
                  ...
                  onClick={() => fetchUsers(i, searchInput)}
                >
                  {i + 1}
                </button>
              ))}
            ...
            <div className="us-modal-wrap">
              ...
              >
                ...
                <p className="us-del-desc">
                  Tài khoản <strong>{confirm.user.username}</strong> sẽ bị xóa
            ...
            <div className="us-modal-wrap">
              ...
              >
                ...
                <div className="us-del-title">
                  {confirm.user.locked ? "Mở khóa tài khoản" : "Khóa tài khoản"}
                </div>
                <p className="us-del-desc">
                  Bạn có chắc muốn {confirm.user.locked ? "mở khóa" : "khóa"}{" "}
                  tài khoản <strong>{confirm.user.username}</strong>?
                </p>
                <div className="us-del-actions">
                  <button
                    className="us-del-cancel"
                  ...
                  <button
                    className={`us-del-confirm ${confirm.user.locked ? "us-del-confirm--unlock" : "us-del-confirm--lock"}`}
